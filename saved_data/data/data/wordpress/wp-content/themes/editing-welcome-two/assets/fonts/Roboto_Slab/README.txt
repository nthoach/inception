...
Addendum by Webdesign Johanna Schürmann:
----------------------------------------

The text below this addendum is a verbatim copy of the readme.txt file that
accompanied the download of the Roboto Slab Variable Font from Google Fonts.

Please note that the theme Editing Welcoe Two Pro only contains the variable font file,
not the static font files for Roboto Slab.
